...
/// <summary>
/// Generates the topology of a dungeon floor using a spanning tree algorithm with optional extra connections.
/// </summary>
public sealed class SpanningTreeGraphGenerator : IGraphGenerator
{
    /// <summary>
