...
/// <summary>
/// Constraint that requires a room to be within a maximum distance from the spawn room (spatial distance, not graph distance).
/// </summary>
...
public sealed class MaxSpatialDistanceFromStartConstraint<TRoomType> : ISpatialConstraint<TRoomType> where TRoomType : Enum
{
    ...
    /// <summary>
    /// Creates a new maximum distance from start constraint.
    /// </summary>
